...
DOMAIN = "ovum_mira"
INTEGRATION_VERSION = "0.1.0-beta.4"
PLATFORMS = [
    Platform.SENSOR,
    Platform.SELECT,
    Platform.NUMBER,
...
CONF_DHW_HOLIDAY_DETECTION = "dhw_holiday_detection_enabled"
CONF_DHW_HOLIDAY_THRESHOLD = "dhw_holiday_target_threshold"
DEFAULT_DHW_HOLIDAY_THRESHOLD = 15.0
