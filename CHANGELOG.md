...
- Build installation options through one shared config-entry mapping.
- Simplify stable entity object-ID selection without changing public IDs.
...
- Remove the unused raw-register diagnostics helper and legacy compressor-runtime alias.
